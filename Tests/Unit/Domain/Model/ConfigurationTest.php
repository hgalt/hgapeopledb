...
/**
 * Test case for class \HGA\Hgapeopledb\Domain\Model\Configuration.
 *
...
class ConfigurationTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \HGA\Hgapeopledb\Domain\Model\Configuration
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \HGA\Hgapeopledb\Domain\Model\Configuration();
	}
	 ...
	 * @test
	 */
	public function getContentReturnsInitialValueFor() {	}

	/**
	 * @test
	 */
	public function setContentForSetsContent() {	}
}
