...
/**
 * Test case for class \HGA\Hgapeopledb\Domain\Model\CustomFrontendUser.
 *
...
class CustomFrontendUserTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \HGA\Hgapeopledb\Domain\Model\CustomFrontendUser
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \HGA\Hgapeopledb\Domain\Model\CustomFrontendUser();
	}
	...
	public function setAddressForAddressSetsAddress() {
		$addressFixture = new \HGA\Hgapeopledb\Domain\Model\Address();
