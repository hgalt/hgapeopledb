 ...
 */
 #[Controller]
 final class PeopleBackendController extends ActionController{
//class PeopleBackendController extends ActionController {

     public function __construct(
		private readonly ResponceFactory $factory,
	...
	public function __invoke(RequestInterface $request): ResponceInterface {
		$this->view->setLayoutRootPaths(['EXT:hgapeopledb/Resources/Private/Layouts']);
		$this->view->setTemplateRootPaths(['EXT:hgapeopledb/Resources/Private/Templates']);
		$this->view->setPartialRootPaths(['EXT:hgapeopledb/Resources/Private/Partials']);
		$this->view->setTemplate(templateName: 'List');
		$moduleTemplate = $this->moduleTemplateFactory-create($request);
		$moduleTemplate->setContent(content: $this->view->render());
